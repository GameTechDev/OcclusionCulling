...
#ifndef AABBoxRasterizerAVX_H
#define AABBoxRasterizerAVX_H

#include "AABBoxRasterizer.h"
#include "TransformedAABBoxAVX.h"

class AABBoxRasterizerAVX : public AABBoxRasterizer
{
	public:
		AABBoxRasterizerAVX();
		virtual ~AABBoxRasterizerAVX();
	...
	protected:
		...
		UINT mNumModels;
		TransformedAABBoxAVX *mpTransformedAABBox;
