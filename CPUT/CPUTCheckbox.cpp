...
// UV coordinates in the atlas texture for each part of the checkbox image
...
CPUTResult CPUTCheckbox::RegisterStaticResources()
{
    ...
    mpCheckboxTextureSizeList[0].height = gUVLocationsCheckbox_active[3] - gUVLocationsCheckbox_active[1];

    mpCheckboxTextureSizeList[1].width = gUVLocationsCheckbox_pressed[2] - gUVLocationsCheckbox_pressed[0];
    mpCheckboxTextureSizeList[1].height = gUVLocationsCheckbox_pressed[3] - gUVLocationsCheckbox_pressed[1];

    mpCheckboxTextureSizeList[2].width = gUVLocationsCheckbox_disabled[2] - gUVLocationsCheckbox_disabled[0];
    mpCheckboxTextureSizeList[2].height = gUVLocationsCheckbox_disabled[3] - gUVLocationsCheckbox_disabled[1];
