...
////--------------------------------------------------------------------------------
//CPUTResult CPUTGuiControllerDX11::CreatePane(ID3D11DeviceContext *pImmediateContext, const cString PaneText, CPUTControlID controlID, CPUTControlID panelID, CPUTPaneDX11 **ppPane)
//{
//    //if((NULL==pImmediateContext) || (NULL==ppPane))
//        //return CPUT_ERROR_INVALID_PARAMETER;
//
//    // create the control
//    *ppPane = new CPUTPaneDX11(pImmediateContext, PaneText, controlID);
//    ASSERT(NULL!=*ppPane, _L("Failed creating pane") );
//
//    // add control to the gui manager
//    return this->AddControl(*ppPane, panelID);
//}
