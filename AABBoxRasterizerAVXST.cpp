...
AABBoxRasterizerAVXST::AABBoxRasterizerAVXST()
	: AABBoxRasterizerAVX()
{
...
void AABBoxRasterizerAVXST::WaitForTaskToFinish(UINT idx)
{
}

void AABBoxRasterizerAVXST::ReleaseTaskHandles(UINT idx)
{
}