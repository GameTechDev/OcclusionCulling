...
#ifndef AABBOXRASTERIZERSCALARMT_H
#define AABBOXRASTERIZERSCALARMT_H

#include "AABBoxRasterizerScalar.h"

class AABBoxRasterizerScalarMT : public AABBoxRasterizerScalar
{
	public:
...
#endif //AABBOXRASTERIZERSCALARMT_H